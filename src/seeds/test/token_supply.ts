...
exports.seed = async (knex: Knex): Promise<any> => {
  ...
  return knex("token_supply").del().then(async (): Promise<any> => {
    ...
    const seedData = [{
      ...
      token: "0x0124000000000000000000000000000000000000",
      supply: "200000000000000000000000000000000000000000000",
    }, {
      token: "0x0124A00000000000000000000000000000000000",
      supply: "200000000000000000000000000000000000000000000",
    }, {
      token: "0x0124B00000000000000000000000000000000000",
      supply: "200000000000000000000000000000000000000000000",
    }, {
      token: "0x0124C00000000000000000000000000000000000",
      supply: "200000000000000000000000000000000000000000000",
    }, {
      token: "0x0124100000000000000000000000000000000000",
      supply: "200000000000000000000000000000000000000000000",
    }];
