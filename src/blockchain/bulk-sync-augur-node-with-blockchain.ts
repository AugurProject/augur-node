...
export async function bulkSyncAugurNodeWithBlockchain(db: Knex, pouch: PouchDB.Database, augur: Augur): Promise<number> {
  ...
  await promisify(downloadAugurLogs)(db, pouch, augur, fromBlock, handoffBlockNumber);
  setSyncFinished();
