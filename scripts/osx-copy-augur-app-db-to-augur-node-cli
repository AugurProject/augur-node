...
# It's possible to run migrations from the command-line, but this shouldn't be done because Knex via cli doesn't properly set postProcessDatabaseResults and so migrations don't work from cli in general.
